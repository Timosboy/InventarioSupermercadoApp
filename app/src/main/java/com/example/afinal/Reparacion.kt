...
class Reparacion : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val cambioA: CheckBox = findViewById(R.id.cbCambioA2)
        val llenadoLR3: CheckBox = findViewById(R.id.cbLlenadoLR2)
        val llenadoLF3: CheckBox = findViewById(R.id.cbLlenadoLF2)
        val cambioF: CheckBox = findViewById(R.id.cbCambioF2)
        val descripcion: EditText = findViewById(R.id.etDescripcion3)
        val costo: EditText = findViewById(R.id.etcosto3)
        val registro: Button = findViewById(R.id.botonRegistrar2)
        val todo: TextView = findViewById(R.id.tvTodo3)
        val clientess: Spinner = findViewById(R.id.spCliente2)
        val vehiculoss: ListView = findViewById(R.id.lvVehiculos)
        val resumen: Button = findViewById(R.id.btResumen1)

        val i: Intent = intent
        val texto: String? = i.getStringExtra("variable")

        val volver: TextView = findViewById(R.id.tvRegresar2)
        ...
        if (cursor.moveToFirst()) {
            ...
            Log.d("Reparacion", "No se encontraron clientes.")
        }
        ...
        clientess.onItemSelectedListener = object : AdapterView.OnItemSelectedListener {
            override fun onItemSelected(parent: AdapterView<*>, view: View?, position: Int, id: Long) {
                ...
                if (cursor2.moveToFirst()) {
                    ...
                    Log.d("Reparacion", "No se encontraron vehículos para el cliente seleccionado.")
                }
                ...
                if (placasVehiculos.isEmpty()) {
                    ...
                    Log.d("Reparacion", "Vehículos encontrados: ${placasVehiculos.joinToString()}")
                }

                val adapter2 = ArrayAdapter(this@Reparacion, android.R.layout.simple_list_item_1, placasVehiculos)
                ...
                registro.setOnClickListener {
                    ...
                    try {
                        ...
                        Toast.makeText(this@Reparacion, "Registro guardado con éxito", Toast.LENGTH_SHORT).show()
                    } catch (e: Exception) {
                        Log.e("Diagnostico", "Error al insertar servicio: ${e.message}")
                    } finally {
                        instanciaBD.close()
                    }
                    var iratras = Intent(this@Reparacion, VerServicios::class.java)
